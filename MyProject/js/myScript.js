...
var calculator = {
	sum: function () {
		...
		let layout = [
		['Выбранный вами тип вёрстки: "Адаптивный!" Стоимость: 2200 руб! Примерные сроки: 8 дней!',
		'Выбранный вами тип вёрстки: "Мобильная!" Стоимость: 1800 руб! Примерные сроки: 4 дня!',
		'Выбранный вами тип вёрстки: "Pixel Perfect!" Стоимость: 2600 руб! Примерные сроки: 12 дней!'],
		[2200,1800,2600],
		[8,4,12]
		];

		let count3 = prompt('Какой вы хотите тип вёрстки?\nВыберите из предложенного списка:\n0. Адаптивный\n1. Мобильный\n2. Pixel Perfect');
