...
$("#inputTel").mask("+38(999) 999-9999");

////////////////////////////////////////////////////////////////////////////////////////
$(function(){
    $('.inpurScroll1').on('click', function(e){
        $('html,body').stop().animate({ scrollTop: $('#myinfo').offset().top }, 1000);
        e.preventDefault();
    });
    $('.inpurScroll2').on('click', function(e){
        $('html,body').stop().animate({ scrollTop: $('#cases').offset().top }, 1000);
        e.preventDefault();
    });
});
